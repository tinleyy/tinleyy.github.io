...
import { IndexSensorsResponse, IndexSensorsRequest, ChartDataResponse } from './types';
...
export const updateOneIndexSensor = async (id: number, req: IndexSensorsRequest): Promise<IndexSensorsResponse> => {
